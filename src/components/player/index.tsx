...
export function Player() {
    ...
    const {episodeList, currentEpisodeIndex, isPlaying, togglePlay, setPlayingState, playNext, playPrevious, hasNext, hasPrevious, isLooping, toggleLoop, toggleShuffe, isShuffling, clearPlayerState} =usePlayer()
            ...
            <footer className={!episode ? styles.empty:''}>
                ...
                <div className={styles.buttons}>
                    ...
                    <button type="button" className={styles.playButton} disabled={!episode}>
                        {isPlaying ? <img src="/pause.svg" alt="Pausar" onClick={togglePlay}/>
